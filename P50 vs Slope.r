...
plot(datao$P50, datao$sigma,
     ...
     xlim=c(-10, 0), ylim=c(0, 1.5), cex.lab=1.3)
...
text(-10*0.965, 1.5*0.965, "c)", cex=1.3)
axis(1, xlim=c(-10, 0), pos=0, lwd=2, at=c(-10, -5, 0))
...
legend("topright", legend=expression(Martinez-vilalta~italic(et~al.)~2014), lty=3, pch=1)
